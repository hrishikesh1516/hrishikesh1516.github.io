...
function renderContent() {
    ...
    const createTimelineItem = (item, delay) => `
        <div class="timeline-item animate-in" style="animation-delay: ${delay}s">
            ...
            <div class="timeline-subtitle">${item.company || item.institution}</div>
    ...
    galleryContainer.innerHTML = cvData.gallery.map((img, i) => `
        < div class="gallery-item animate-in" style = "animation-delay: ${i * 0.1}s" >
